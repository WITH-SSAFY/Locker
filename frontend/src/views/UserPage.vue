        ...
        <v-col cols="12" md="12" class="p-0">
          <div class="row align-items-center mx-5 mb-5">
            ...
            <div class="col-md-4 d-flex-wrap align-self-start">
              ...
              <p class="thin" style="font-size: 1.1rem;">
                {{ userInfo.introduction }}
              </p>

              <div class="d-inline mt-5">
                <a>
                  <v-icon size="35" style="color: black; padding-right: 1rem;"
                    >mdi-github</v-icon
                  >
                </a>
                <a>
                  <v-icon size="35" style="color: black;"
            ...
            <div class="col-md-5">
              ...
              <div
                v-else
                style="min-height: 10rem; background-color: #eceffc; padding: 2rem;"
              >
                <div class="text-center">
                  ...
                  <p class="medium">
                    <strong style="color: #7C4DFF">LOCKER</strong>에서 확인할 수
                    있어요
                  </p>
                  ...
                  >
                    <v-icon size="23" style="color: black; padding-right: 1rem;"
                      >mdi-github</v-icon
                    >
                    <span class="bolder" style="font-size: 1rem;"
                      >깃헙 연동 바로가기</span
                    >
                  </v-btn>
                </div>
          ...
          <article id="tab">
            <ul class="p-0">
              ...
              <li style="cursor: default;">
                <span class="bold" style="color: #727272; font-size: 1.3rem;"
                  >반가워요 :)</span
                >
              </li>
              ...
              <router-link to="article">
                <li>
                  <span class="bold" style="color: #eceffc;; font-size: 1.3rem;"
                    >포스트</span
                  >
                </li>
              </router-link>
...
export default {
  created() {
    ...
    // this.token = token;
    this.token =
      "eyJhbGciOiJIUzI1NiJ9.eyJzdWIiOiIyMSIsInJvbGVzIjpbIlJPTEVfVVNFUiJdLCJpYXQiOjE1OTc5MjMwOTgsImV4cCI6MTU5NzkyNjY5OH0.Q7MGkKSrtLatp0_P3dkPnonIDtTmDKBQsOwBO32ERgA";
    // let accessToken = localStorage.getItem("github_token");
    // this.accessToken = accessToken;
    this.accessToken = "cc0cc3f2d7e3fe43d851db386842e186927ce4e5";
